...
<br/>
	...
	<%
		...
		String sql="Select * from game_genre where GenreID=?";
		...
		String sql2="delete from genre where GenreID=?";
		...
		out.println(rs2 + " rows affected");
			...
			out.println("Cannot delete a genre that is linked to existing games!");
		}
	%>
